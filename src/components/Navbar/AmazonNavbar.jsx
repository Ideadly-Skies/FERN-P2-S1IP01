...
export default function Navbar({ onCategoryChange, onSearchChange }) {
  ...
  return (
    <header className="bg-[#131921] text-white flex items-center justify-between px-4 py-2 relative">
      ...
      <div
        tabIndex={0}
        className="hidden md:flex flex-col text-xs ml-4 leading-tight cursor-pointer focus:outline-none focus:ring-2 focus:ring-white hover:outline hover:outline-2 hover:outline-white rounded-sm"
      ...
      <div
        tabIndex={0}
        className="hidden md:flex items-center text-sm mr-4 cursor-pointer focus:outline-none focus:ring-2 focus:ring-white hover:outline hover:outline-2 hover:outline-white rounded-sm"
      >
      ...
      <div
        tabIndex={0}
        className="hidden md:flex flex-col text-sm mr-4 cursor-pointer focus:outline-none focus:ring-2 focus:ring-white hover:outline hover:outline-2 hover:outline-white rounded-sm"
        onClick={() => { if (!user) navigate("/auth/login"); }}
      >
        <span>Returns</span>
